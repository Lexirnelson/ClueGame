...
public class FileInitTests {
	...
	// Board static because I only want to set it up one
	...
	public void testRoomLabels() {
		...
		assertEquals("Sheriff Station", board.getRoom('P').getName() );
	...
	// Test a doorway in each direction (RIGHT/LEFT/UP/DOWN), plus
		...
		public void testRooms() {
			...
			BoardCell cell = board.getCell( 20, 14);
			Room room = board.getRoom( cell ) ;
			assertTrue( room != null );
			assertEquals( room.getName(), "Saloon" ) ;
			...
			assertTrue( room != null );
			assertEquals( room.getName(), "Sheriff Station" ) ;
			...
			room = board.getRoom( cell ) ;
			assertTrue( room != null );
			assertEquals( room.getName(), "Inn" ) ;
			assertTrue( cell.isRoomCenter() );
			assertTrue( room.getCenterCell() == cell );
			
			// this is a secret passage test
			cell = board.getCell(25, 11);
			room = board.getRoom( cell ) ;
			assertTrue( room != null );
			assertEquals( room.getName(), "Saloon" ) ;
